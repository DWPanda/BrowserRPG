let GameManager = {
  ...
  resetPlayer: function(classType) {
    switch (classType) {
      case "Warrior":
        player = new Player(classType, 3000, 0, 200, 100, 50);
        break;
      case "Rogue":
        player = new Player(classType, 1000, 0, 120, 200, 150);
        break;
      case "Mage":
        player = new Player(classType, 1800, 0, 70, 180, 50);
        break;
      case "Hunter":
        player = new Player(classType, 2000, 0, 50, 200, 100);
        break;
    }
  ...
  setFight: function(enemyType) {
    ...
    // Create Enemy!
    let enemy00 = new Enemy("Goblin", 1500, 0, 50, 100, 100);
    let enemy01 = new Enemy("Troll", 2000, 0, 150, 80, 150);
